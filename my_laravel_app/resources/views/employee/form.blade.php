<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="company" class="form-control @error('company') is-invalid @enderror" value="{{ old('company', $employee?->company) }}" id="company" placeholder="Company">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="email_address" class="form-control @error('email_address') is-invalid @enderror" value="{{ old('email_address', $employee?->email_address) }}" id="email_address" placeholder="Email Address">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="job_title" class="form-control @error('job_title') is-invalid @enderror" value="{{ old('job_title', $employee?->job_title) }}" id="job_title" placeholder="Job Title">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="business_phone" class="form-control @error('business_phone') is-invalid @enderror" value="{{ old('business_phone', $employee?->business_phone) }}" id="business_phone" placeholder="Business Phone">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="home_phone" class="form-control @error('home_phone') is-invalid @enderror" value="{{ old('home_phone', $employee?->home_phone) }}" id="home_phone" placeholder="Home Phone">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="mobile_phone" class="form-control @error('mobile_phone') is-invalid @enderror" value="{{ old('mobile_phone', $employee?->mobile_phone) }}" id="mobile_phone" placeholder="Mobile Phone">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fax_number" class="form-control @error('fax_number') is-invalid @enderror" value="{{ old('fax_number', $employee?->fax_number) }}" id="fax_number" placeholder="Fax Number">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="state_province" class="form-control @error('state_province') is-invalid @enderror" value="{{ old('state_province', $employee?->state_province) }}" id="state_province" placeholder="State Province">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="zip_postal_code" class="form-control @error('zip_postal_code') is-invalid @enderror" value="{{ old('zip_postal_code', $employee?->zip_postal_code) }}" id="zip_postal_code" placeholder="Zip Postal Code">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="country_region" class="form-control @error('country_region') is-invalid @enderror" value="{{ old('country_region', $employee?->country_region) }}" id="country_region" placeholder="Country Region">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="web_page" class="form-control @error('web_page') is-invalid @enderror" value="{{ old('web_page', $employee?->web_page) }}" id="web_page" placeholder="Web Page">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="attachments" class="form-control @error('attachments') is-invalid @enderror" value="{{ old('attachments', $employee?->attachments) }}" id="attachments" placeholder="Attachments">
