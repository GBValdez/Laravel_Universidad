...
DROP TABLE IF EXISTS 
  `bitnami_laravel`.`customers`,
  `bitnami_laravel`.`employees`,
  `bitnami_laravel`.`privileges`,
  `bitnami_laravel`.`employee_privileges`,
  `bitnami_laravel`.`inventory_transaction_types`,
  `bitnami_laravel`.`shippers`,
  `bitnami_laravel`.`orders_tax_status`,
  `bitnami_laravel`.`orders_status`,
  `bitnami_laravel`.`orders`,
  `bitnami_laravel`.`products`,
  `bitnami_laravel`.`purchase_order_status`,
  `bitnami_laravel`.`suppliers`,
  `bitnami_laravel`.`purchase_orders`,
  `bitnami_laravel`.`inventory_transactions`,
  `bitnami_laravel`.`invoices`,
  `bitnami_laravel`.`order_details_status`,
  `bitnami_laravel`.`order_details`,
  `bitnami_laravel`.`purchase_order_details`,
  `bitnami_laravel`.`sales_reports`,
  `bitnami_laravel`.`strings`;
SET FOREIGN_KEY_CHECKS = 1;

-- -----------------------------------------------------
-- Table `bitnami_laravel`.`customers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`customers` (
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`employees`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`employees` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`privileges` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`employee_privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`employee_privileges` (
  ...
  CONSTRAINT `fk_employee_privileges_employees1`
    ...
    REFERENCES `bitnami_laravel`.`employees` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_employee_privileges_privileges1`
    FOREIGN KEY (`privilege_id`)
    REFERENCES `bitnami_laravel`.`privileges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`inventory_transaction_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`inventory_transaction_types` (
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`shippers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`shippers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`orders_tax_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`orders_tax_status` (
  `id` TINYINT(4) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`orders_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`orders_status` (
  `id` TINYINT(4) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_orders_customers`
    ...
    REFERENCES `bitnami_laravel`.`customers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_orders_shippers`
    ...
    REFERENCES `bitnami_laravel`.`shippers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_tax_status`
    FOREIGN KEY (`tax_status_id`)
    REFERENCES `bitnami_laravel`.`orders_tax_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_status`
    FOREIGN KEY (`status_id`)
    REFERENCES `bitnami_laravel`.`orders_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`products` (
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`purchase_order_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`purchase_order_status` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`suppliers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`suppliers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`purchase_orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`purchase_orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_orders_purchase_order_status`
    FOREIGN KEY (`status_id`)
    REFERENCES `bitnami_laravel`.`purchase_order_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_purchase_orders_suppliers`
    FOREIGN KEY (`supplier_id`)
    REFERENCES `bitnami_laravel`.`suppliers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`inventory_transactions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`inventory_transactions` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`invoices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`invoices` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`order_details_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`order_details_status` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `status_name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_order_details_order_details_status`
    FOREIGN KEY (`status_id`)
    REFERENCES `bitnami_laravel`.`order_details_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`purchase_order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`purchase_order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_order_details_inventory_transactions`
    ...
    REFERENCES `bitnami_laravel`.`inventory_transactions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`sales_reports`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`sales_reports` (
...
-- -----------------------------------------------------
-- Table `bitnami_laravel`.`strings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bitnami_laravel`.`strings` (
